   ...
   */
    ...
    */
    'database' => [
        ...
        'users_table' => 'agent_admin_users',
        'users_model' => AgentAdminUsers::class,

        // Role table and model.
        'roles_table' => 'agent_admin_roles',
        'roles_model' => AgentAdminRoles::class,

        // Permission table and model.
        'permissions_table' => 'agent_admin_permissions',
        'permissions_model' => AgentAdminPermissions::class,

        // Menu table and model.
        'menu_table' => 'agent_admin_menu',
        'menu_model' => AgentAdminMenu::class,
